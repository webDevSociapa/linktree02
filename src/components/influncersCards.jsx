...
const InfluencerCards = () => {
    const CardsData = [
        ...
        { id: "3", image: R4, name: "Influencer 3" },
    ];
        ...
        <div className="bg-black text-white text-center py-10">
            ...
            <div className="flex justify-center items-center mt-8">
                {CardsData.map((card, index) => (
                    <div
                        key={card.id}
                        className={`relative w-48 h-64 rounded-2xl overflow-hidden shadow-lg transform transition-transform duration-500 ${index % 2 === 0 ? "rotate-6" : "-rotate-6"
                            } [perspective:1000px]`}
                    >
